import{_ as n,o as s,c as a,d as e}from"./app-8bfb14ad.js";const c={},t=e(`<p>早些时候又被朋友怼了，产出太慢，今天继续接上回说到的自定义宏。</p><h1 id="直接开码" tabindex="-1"><a class="header-anchor" href="#直接开码" aria-hidden="true">#</a> 直接开码</h1><p>话不多说咱直接开码，我们<code>cargo new my_macro</code>创建一个包。然后修改<code>main.rs</code>：</p><div class="language-rust line-numbers-mode" data-ext="rs"><pre class="language-rust"><code><span class="token keyword">extern</span> <span class="token keyword">crate</span> <span class="token module-declaration namespace">my_macro</span><span class="token punctuation">;</span>
