import{_ as e,o as n,c as a,d as s}from"./app-8bfb14ad.js";const i={},d=s(`<p>今天我们来介绍Rust中一个重要的神器：Cargo，它是Rust中用来构建系统和管理相关依赖包的工具。之前我们也提过可以使用Cargo来处理代码构建、依赖下载等等。</p><h1 id="构建项目" tabindex="-1"><a class="header-anchor" href="#构建项目" aria-hidden="true">#</a> 构建项目</h1><p>还记得上一次我们新建的HelloWorld程序么，我们需要手工新建目录和源文件。接下来我们使用Cargo来进行创建，看看有啥不一样的地方。</p><p>在这之前我们需要确认安装了Cargo，可以输入<code>cargo --version</code>来检查是否安装Cargo。</p><p>然后我们进入项目目录，输入以下命令：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ <span class="token function">cargo</span> new hello_world
