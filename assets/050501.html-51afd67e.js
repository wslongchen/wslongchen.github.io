import{_ as e,o as n,c as a,d as s}from"./app-39c5096f.js";const i={},d=s(`<p>今天我们来介绍Rust中一个重要的神器：Cargo，它是Rust中用来构建系统和管理相关依赖包的工具。之前我们也提过可以使用Cargo来处理代码构建、依赖下载等等。</p><h1 id="构建项目" tabindex="-1"><a class="header-anchor" href="#构建项目" aria-hidden="true">#</a> 构建项目</h1><p>还记得上一次我们新建的HelloWorld程序么，我们需要手工新建目录和源文件。接下来我们使用Cargo来进行创建，看看有啥不一样的地方。</p><p>在这之前我们需要确认安装了Cargo，可以输入<code>cargo --version</code>来检查是否安装Cargo。</p><p>然后我们进入项目目录，输入以下命令：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ <span class="token function">cargo</span> new hello_world
...
Hello, world!
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>看到同样的输出，我们激动的抹上眼泪。</p><h1 id="下课" tabindex="-1"><a class="header-anchor" href="#下课" aria-hidden="true">#</a> 下课</h1><p>不难发现，Cargo真的是一个很好的助手，它能够帮助我们更好的管理项目，特别是项目越来越大，依赖的crate库越来多，把它交给Cargo将会变的十分简单。</p><p>所以我们已经知道了如何使用Cargo来构建应用了，打字员们可以在下方以及WX搜索【一名打字员】留言自己的相关问题哟。</p>`,24),l=[d];function r(o,t){return n(),a("div",null,l)}const u=e(i,[["render",r],["__file","050501.html.vue"]]);export{u as default};
